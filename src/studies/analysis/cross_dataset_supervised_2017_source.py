...
def supervised_pipeline_cross_dataset():
    training_raw = load_csv_after_removing_duplicates("data/CICIDS2017/Wednesday-workingHours.pcap_ISCX.csv")
    ...
    for name_of_target, config in target_dataset_for_testing.items():
        ...
        try:
            ...
            target_output_dir = os.path.join("results", "studies", "analysis", "cross_dataset_supervised_2017_source")
...
if __name__ == "__main__":
    supervised_pipeline_cross_dataset()